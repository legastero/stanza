    ...
    this.features.sasl = function (features, cb) {
        ...
        self.on('sasl:challenge', 'sasl', function (challenge) {
            ...
            if (mech.saltedPassword) {
                self.config.credentials.saltedPassword = btoa(mech.saltedPassword);
                delete self.config.credentials.password;
...
Client.prototype.getCredentials = function () {
    ...
    if (result.saltedPassword) {
        result.saltedPassword = atob(result.saltedPassword);
    }
