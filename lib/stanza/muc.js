...
module.exports = function (stanza) {
    ...
    var UserItem = stanza.define({
        ...
        fields: {
            ...
            reason: types.subText(USER_NS, 'reason')
        }
    });
    ...
    var AdminItem = stanza.define({
        ...
        fields: {
            ...
            jid: types.jidAttribute('jid'),
            role: types.attribute('role'),
            reason: types.subText(ADMIN_NS, 'reason')
        }
    });
    ...
    var Destroy = stanza.define({
        ...
        fields: {
            jid: types.jidAttribute('jid'),
            password: types.subText(OWNER_NS, 'password'),
            reason: types.subText(OWNER_NS, 'reason')
        }
    });
    ...
    var MUC = stanza.define({
        ...
        fields: {
            ...
            password: types.subText(USER_NS, 'password'),
            codes: {
                get: function () {
    ...
    stanza.withIq(function (Iq) {
        stanza.add(Iq, 'mucUnique', types.subText(UNIQ_NS, 'unique'));
