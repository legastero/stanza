...
_Instantiating a client via this function will not load any built-in plugins._
...
_Instantiating a client via this function will load all built-in plugins._
...
-   `nick` - The requested nickname to use in the room. _Note:_ You are not guaranteed to be assigned this nick.
...
```js
client.enableNotifications('push.example.im', 'e4109a84-89aa-11e8-9373-431c37c82976', [
